...
begin
   insert into fuse_provider (provider_name, provider_url) values ('together', 'https://api.together.xyz/v1/chat/completions');
   insert into fuse_provider (provider_name, provider_url) values ('anthropic', 'https://api.anthropic.com/v1/messages');
   insert into fuse_provider (provider_name, provider_url) values ('openai', 'https://api.openai.com/v1/chat/completions');
end;
/
